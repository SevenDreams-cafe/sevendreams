...
export default function CetakStruk() {
  ...
  return (
    <div
      className={`px-6 text-center mt-10 print:mt-4 w-[90%] sm:w-1/2 lg:w-1/3 xl:w-[25%] print:w-full mx-auto text-xs bg-neutral-50 py-6 print:py-0 rounded-lg ${ars_one_sans.className}`}
    >
